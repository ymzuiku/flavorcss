...
it("border:--px|solid|--red!", () => {
  const css = parseAtom("border:--px|solid|--red!");
  expect(css.trim()).toEqual(
    `.border\\:--px\\|solid\\|--red\\! { border: var(--px) solid var(--red) !important; }`,
  );
});
...
it("bg:rgba(--red-500,0.1)", () => {
  const css = parseAtom("bg:rgba(--red-500,0.1)");
  expect(css.trim()).toEqual(
    `.bg\\:rgba\\(--red-500\\,0\\.1\\) { background: rgba(var(--red-500),0.1); }`,
  );
});

it("bg:#f00", () => {
  const css = parseAtom("bg:#f00");
...
it("div>ul:background:#f00", () => {
  const css = parseAtom("div>ul:background:#f00");
  expect(css.trim()).toEqual(
    `.div\\>ul\\:background\\:\\#f00 div>ul { background: #f00; }`,
  );
});

it("div>ul:hover:background:#f00", () => {
  const css = parseAtom("div>ul:hover:background:#f00");
  expect(css.trim()).toEqual(
    `.div\\>ul\\:hover\\:background\\:\\#f00 div>ul:hover { background: #f00; }`,
  );
});

it("div>ul:sm:background:#f00", () => {
  const css = parseAtom("div>ul:sm:background:#f00");
  expect(css.trim()).toEqual(
...
it("div>ul:sm:hover:background:--m2", () => {
  const css = parseAtom("div>ul:sm:hover:background:--m2");
  expect(css.trim()).toEqual(
...
it("div>ul:dark:sm:background:--m2", () => {
  const css = parseAtom("div>ul:dark:sm:background:--m2");
  expect(css.trim()).toEqual(
...
it("div>ul:dark:sm:hover:background:--m2", () => {
  const css = parseAtom("div>ul:dark:sm:hover:background:--m2");
  expect(css.trim()).toEqual(
