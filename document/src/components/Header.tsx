export const Header = () => {
  return (
    <div class="h:--bar-height bb:1px|solid|--gray d:grid content:start,center p:--md cols:1fr|auto self:auto,center:>label">
      <span class="mono fw:900 fs:--h3 text-gradient:45deg,--primary,--black">
        flavorcss
      </span>
      <label>
        <svg
