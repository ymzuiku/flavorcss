...
export default function Nav() {
  ...
  return (
    <nav className="px-sm h-2xl bg-white fixed w-12/12 top-0 left-0 bb-px b-gray-300 row start-center z-20">
      <img
        className="w-xl h-xl mr-md"
        src="/static/imgs/flavorcss-logo.svg"
      ></img>
      ...
      {list.map((v) => {
        ...
        return (
          <Link key={v.url} href={v.url}>
            <a
              className={[
                "def none pc:flex mx-sm px-md c-primary-600 hover:c-primary-900 hover:bg-primary-200 h-12/12 row center-center",
