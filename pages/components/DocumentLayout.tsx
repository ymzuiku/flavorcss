    ...
    <div className="pc:none">
     <div
      ...
      <div
        ...
        ></div>
      <div className={["cursor-pointer fixed top-3xl bg-indigo-700 c-white p-sm ml-sm mt--sm radius-sm shadow-lg left-0 z-20 row transition-400", showSide && "move-x-5xl"].join(' ')} onClick={()=>setShowSide(!showSide)}>
        <svg
          className={[
            "align-middle w-md h-md fill-current transition-0",
            showSide && "scale--100",
          ].join(" ")}
          data-style="width: 1em; height: 1em;vertical-align: middle;fill: currentColor;overflow: hidden;"
