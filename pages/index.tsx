  ...
  return (
    <div className="h-vh overflow-y-auto">
      ...
      <div className="mt-3xl max-w-middle bg-white mx-auto col center-center b-px b-teal-300 radius-sm m-xl p-xl">
        ...
        <h4 className="fs-sm p-sm text-teal-600">
          提交编译好你所需要的所有CSS
        </h4>
      </div>
      <CodeEditor
...
<section class="bg-gray-500 p-lg">
      <div
        class="max-w-middle mx-auto w-full sm:max-w-12/12 lg:flex b-0 b-teal-500 shadow-md bg-white radius-md mt-lg overflow-hidden">
        ...
        <div class="p-lg col">
          <div class="fs-sm text-gray-600 row start-center items-center">
            <svg class="fill-current text-gray-500 w-md h-md mr-sm" xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20">
              <path
          ...
          <div class="fs-2xl text-teal-800 fw-700 pt-md">
            您是否有尝试过原子风格的CSS编写方式?
          </div>
          <p class="fs-md text-teal-800 text-opa-70 line-2xl pt-md">
          ...
          <div class="row start-center pt-md">
            ...
            <div class="col px-md">
              ...
              <p class="fs-sm text-teal-500 pt-sm">Aug 18</p>
            </div>
          </div>
        </div>
      </div>
